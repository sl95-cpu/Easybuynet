        ...
        <span class="fr">
        	<span class="fl">${user.userName}
                <c:if test="${user.userName==null}">
                    你好，请<a href="${pageContext.request.contextPath}/toLogin">登录</a>&nbsp; <a href="${pageContext.request.contextPath}/toRegis" style="color:#ff4e00;">免费注册</a>
                </c:if>
            <a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
        ...
        <div class="inews">
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    var url = "${pageContext.request.contextPath}/allnew";
                   ...
                   $.post(url,data,function (res) {
                        var list = res.list;
                        alert(list);
                       var newul = $("#newlist").html("");
                       var li = "";
                        $.each(list,function (index,item) {
                            li += 	"<li><span>[ 特惠 ]</span><a href='#'>"+item.title+"</a></li>"
                        })
                       newul.append(li);
                   },"json")
